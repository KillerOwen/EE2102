...
$A$ & Blood Group O\\
\hline
$A^{\prime}$ & Any other blood group\\
\hline
$B$ & Left-Handed person\\
\hline
\end{tabular}
\end{center}
We need to find the value of $\pr{A|B}$. We are given that,
\begin{align}
\pr{A} &= 0.3\\
...
\pr{B} &= 0.018 + 0.07\\
       &= 0.088
\end{align}
So, $\pr{A|B}$ can be written as,
\begin{align}
\pr{A|B} &= \frac{\pr{BA}}{\pr{B}}\\
	 &= \frac{0.018}{0.088}\\
	 &= \frac{9}{44}
\end{align}
