...
\mu &= np\\
    ...
    &= \frac{5}{4}\\
{\sigma}^2 &= npq\\
	   &= 5\brak{\frac{1}{4}}\brak{\frac{3}{4}}\\
	   &= \frac{15}{16}	
\end{align}
\textbf{Method 1: Gaussian Distribution}\\
For the random variable $X$, the gaussian distribution function is defined as:
\begin{align}
\pr{X = x} &= \frac{1}{\sqrt{2\pi{\sigma}^2}} e^{-\frac{\brak{x-\mu}^2}{2{\sigma}^2}} 
\end{align}
...
Z = \frac{X-\mu}{\sigma}
\end{align}
Now, Z is a random variable with $\mu = 0$ and ${\sigma}^2 = 1$. Hence, the gaussian distribution function changes to:
\begin{align}
\pr{Z = x} &= \frac{1}{\sqrt{2\pi}} e^{-\frac{{x}^2}{2}}\label{9.3.8}
\end{align}
\begin{enumerate}[label=(\alph*)]
\item If we consider all cards to be spades,
\begin{align}
X &= 5\\
Z &= \frac{5 - \frac{5}{4}}{\sqrt{\frac{15}{16}}}\\
  &= \sqrt{15}
\end{align}
Substituting values in \eqref{9.3.8},
\begin{align}
\pr{x = \sqrt{15}} &= \frac{1}{\sqrt{2\pi}} e^{-\frac{15}{2}}\\
	           &= 0.0001245
\end{align}
\item If we consider 3 cards to be spades,
\begin{align}
X &= 3\\
Z &= \frac{3 - \frac{5}{4}}{\sqrt{\frac{15}{16}}}\\
  &= \frac{7}{\sqrt{15}}
\end{align}
Substituting values in \eqref{9.3.8},
\begin{align}
\pr{x = \frac{7}{\sqrt{15}}} &= \frac{1}{\sqrt{2\pi}} e^{-\frac{49}{30}}\\
			      &= 0.044
\end{align}
...
Substituting values in \eqref{9.3.8},
\begin{align}
\pr{x = \sqrt{15}} &= \frac{1}{\sqrt{2\pi}} e^{-\frac{5}{6}}\\
			      &= 0.0978
\end{align}
\end{enumerate}
\pagebreak
\textbf{Method 2: Binomial Distribution}\\
The pmf is given by 
\begin{align} 
