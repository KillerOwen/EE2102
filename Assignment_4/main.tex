...
\implies \pr{A.B} &\leq \pr{A}
\end{align}
\item If A and B are neither mutually exclusive nor independent\\
...
\end{align}
\end{enumerate}
All three cases justify the given statement. Hence, the given statement is true.
\end{document}
