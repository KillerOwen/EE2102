...
\pr{AB} \leq \pr{A}
\end{align}
If we consider conditional probability:
\begin{align}
\pr{B | A} &= \frac{\pr{AB}}{\pr{A}}\\
\pr{AB} &= \pr{B | A}\pr{A}\label{three}
\end{align}
We know that the value of probability ranges from 0 to 1.
\begin{align}
0 \leq \pr{B | A} \leq 1\\
\text{Multiplying \pr{A} both sides}\notag\\
0 \leq \pr{B | A}\pr{A} \leq \pr{A}\\
\text{Substituting value from equation \brak{\ref{three}}}\notag\\
