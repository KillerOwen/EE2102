...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/quantum_fusion/EE2102/Random Vector/figs/triangle.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/quantum_fusion/EE2102/Random Vector/figs/medians.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/quantum_fusion/EE2102/Random Vector/figs/altitudes.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/quantum_fusion/EE2102/Random Vector/figs/incircle.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/quantum_fusion/EE2102/Random Vector/figs/circumcircle.png')
plt.show()
