...
\newline
\begin{align}
\vec{D} &= \myvec{\frac{-7}{2}\vspace{0.1cm}\\\frac{1}{2}}\\
\vspace{2in}
\vec{E} &= \myvec{-1\\-3}\\
\vspace{2in}
\vec{F} &= \myvec{\frac{-3}{2}\vspace{0.1cm}\\\frac{5}{2}}
\end{align}

Now, the slope vector of line DA($\vec{m}$) is :-
\begin{align}
\vec{m} &= \vec{D} - \vec{A}\\
...
$\vec{m}$ can be taken as $\frac{\vec{D} - \vec{A}}{2}, \frac{\vec{D} - \vec{A}}{3}, \frac{\vec{D} - \vec{A}}{4}$ etc. because it will be eliminated while calculating the normal form of line.
\newline

Now, we have to find $\vec{n}^T$ such that $\vec{n}^T.\vec{m}$ = 0.\newline
Let $\vec{n}^T$ be equal to $\myvec{a&b}$.\newline
\newline
This gives us,
\begin{align}
\myvec{\frac{-9}{2}\vspace{0.1cm}\\\frac{3}{2}}\myvec{a&b} &= 0\\
\frac{-9}{2}a + \frac{3}{2}b &= 0\\
3a &= b
\end{align}

Now, any choice of a and b can me made, but for easier understanding we are using $a = \frac{3}{2}$ and $b = \frac{9}{2}$ respectively.\newline
\newline

So, $\vec{n}^T = \myvec{\frac{3}{2}&\frac{9}{2}}$\newline
\newline

Normal form of line AD is :
\begin{align}
